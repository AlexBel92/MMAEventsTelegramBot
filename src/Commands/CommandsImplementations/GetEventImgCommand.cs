...
{
    public class GetEventImgCommand : ICommand
    {
        private readonly IEventsApiClient apiClient;
        private readonly TelegramBotService telegramService;

        public static string Name => "/get_event_img";
        public string CommandName => Name;

        public GetEventImgCommand(IEventsApiClient apiClient, TelegramBotService telegramService)
        {
        ...
        public async Task ExecuteAsync(Update context, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                await telegramService.SendEventImgAsync(message, eventDTO, cancellationToken);
            }
